...
class Address(models.Model):
    ...
    country_iso_code = models.CharField(max_length=3, verbose_name="code pays ISO")
...
class Letting(models.Model):
    ...
    address = models.OneToOneField(Address, on_delete=models.CASCADE, verbose_name="adresse")
